...
function updateImage() {
    ...
    img.style.boxShadow = `0 ${shadow}px ${shadow * 2}px rgba(0,0,0,0.1)`;
...
downloadButton.addEventListener('click', function() {
    ...
    const size = imagePreview.offsetWidth;
    ...
    // 绘制背景
    context.fillStyle = window.getComputedStyle(imagePreview).background;
    ...
    imgElement.onload = function() {
        context.drawImage(imgElement, (canvas.width - imgElement.width) / 2, (canvas.height - imgElement.height) / 2, imgElement.width, imgElement.height);
